...
*/
void LCD_Display_Dir(u8 dir)	//1横屏
{
   u16 regval = 0;
    if(dir)
	{
		lcddev.width = 320;
		lcddev.height = 240;	
		regval = 0xA0;	//20 右为底水平反转 A0右为底  E0 60   --1X R000
	}
	else
	{
		lcddev.width = 240;
		lcddev.height = 320;
		regval = 0x00; //40水平反转 80 垂直反转			  --0X R000
	}
...
void LCD_Fill_CS(u16 xsta,u16 ysta,u16 xend,u16 yend,u16 color)
{          
	u16 i,j; 
